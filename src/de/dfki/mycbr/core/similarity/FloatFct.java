...
/**
 * Calculates the similarity of FloatAttribute objects. There are four modes
...
public class FloatFct extends NumberFct {
	...
	public Similarity calculateSimilarity(Attribute a1, Attribute a2)
		...
		} else if (a1 instanceof FloatAttribute && a2 instanceof FloatAttribute) {

			FloatAttribute att1 = (FloatAttribute) a1;
			FloatAttribute att2 = (FloatAttribute) a2;
	 ...
	 * @throws Exception
	 */
	public Similarity calculateSimilarity(Float value1, Float value2)
			throws Exception {
	...
	public void clone(AttributeDesc descNEW, boolean active) {
		if (descNEW instanceof FloatDesc
				&& !name.equals(Project.DEFAULT_FCT_NAME)) {
			FloatFct f = ((FloatDesc) descNEW).addFloatFct(name, active);
